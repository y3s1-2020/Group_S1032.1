 	...
 	<div class="sidebar" data-color="blue">
 	 ...
 	 <div class="main-panel">
    	 ...
    	 <form action="../paymentController" method="POST"   >
								...
								while(rss.next()){
									appoimentID=rss.getInt("appoimentID");
							 ...
							 %>
									...
									<tr>
										...
										<td><input type="hidden" name="appo" value="<%=appoimentID %>"  /></td>
									</tr>
									<tr>
										<td  >Patient Name</td>
										<td><input type="text" name="patientName" value="<%=patientName %>" readonly/></td>
									</tr>
									<tr>
									
										<td  >Appoinment DateTime</td>
										<td><input type="text" name="appoimentDate" value="<%=appoimentDate %>" /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td  >Hospital Name</td>
										<td><input type="text" name="hosName" value="<%=hosName %>" readonly /></td>
									</tr>
										<tr>
									
										<td  >Hospital Charge</td>
										<td><input type="text" name="hosFees" value="<%=hosFees %>" readonly /></td>
									</tr>
									<tr>
									
										<td  >Doctor Charge</td>
										<td><input type="text" name="doctorfee" value="<%=doctorfees %>" readonly /></td>
									</tr>
									...
									<tr>
										...
										<td  >Payed Date</td>
										<td><input type="text" name="paydate" value="<%=createDate %>" readonly /></td>
									</tr>	
